...
'''
a=[] #list of those numbers greator then 20
...
print(a) #list of those numbers greator then 20

print(b)  #list of those numbers those are less then 10 or equal to 10
